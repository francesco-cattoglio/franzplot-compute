...
pub mod ffi{
    ...
    extern "C" {
        ...
        fn Render(self: &mut Gui, state: Box<RustState>, x_size: u32, y_size: u32);
    ...
    extern "Rust" {
        ...
        fn update_scene_camera(state: &mut Box<RustState>, dx: f32, dy: f32);
...
type RustState<'a> = &'a mut state::State;
